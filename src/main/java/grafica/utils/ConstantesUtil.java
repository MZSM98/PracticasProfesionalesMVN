...
public class ConstantesUtil {
    ...
    public static final String REGEX_TELEFONO = "";
    public static final String REGEX_ESPACIOS_MULTIPLES = "\\s+";
    public static final String REGEX_ESPACIO = " ";
    ...
    public static final String REGEX_USUARIO_VALIDO = "^[a-zA-Z1-9]{9}$";
    ...
    public static final String ALERTA_NOMBRE_PERSONALES = "El nombre sólo puede contener letras";
    public static final String ALERTA_LONGITUD_NOMBRE = "El nombre debe tener al menos 3 letras";
    public static final String ALERTA_LONGITUD_DIRECCION = "La dirección debe tener al menos 3 letras";
    ...
    public static final String ALERTA_LONGITUD_TITULO = "El título debe tener al menos 3 letras";
    ...
    public static final String ALERTA_LONGITUD_DESCRIPCION = "La descripción debe tener al menos 3 letras";
